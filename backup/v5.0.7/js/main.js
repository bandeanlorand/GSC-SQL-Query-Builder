...
function buildCustomFieldSelect({ options, placeholder = 'Select Field' }) {
  ...
  select.className = 'w-[calc(33%-23px)] sm:w-[calc(33%-25px)] hidden'; // hide native; UI will be injected by makeCustomSelect
  // populate
  select.innerHTML =
  ...
  const wrapper = document.createElement('div');
  wrapper.className = 'w-[calc(33%-23px)] sm:w-[calc(33%-25px)] custom-select-wrapper';
...
function buildCustomSingleSelect({ options, placeholder, widthClass }) {
  ...
  const wrapper = document.createElement('div');
  wrapper.className = `relative custom-select-wrap ${widthClass} custom-select-wrapper`;
  wrapper.appendChild(select);
