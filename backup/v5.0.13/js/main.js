...
dimensionEntries.forEach(([name, tooltip]) => {
  ...
  item.className = "relative cursor-pointer p-1 hover:bg-gray-300 rounded-[3px] px-2 flex items-center justify-between";
...
//   el.className = "w-[calc(50%-22px)] select input-lg relative items-center justify-between cursor-pointer focus:outline-none h-auto p-[9px] text-sm device-select";
...
function enableCountrySearchStyled(idPrefix, countries, parentElement) {
  ...
  function renderOptions(filtered) {
    ...
    filtered.forEach(country => {
      ...
      option.className = 'px-3 py-2  hover:bg-gray-200 cursor-pointer ';
