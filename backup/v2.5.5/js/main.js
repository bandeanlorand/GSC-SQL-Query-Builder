...
function createConditionRow(hasRemove = true, addButtons = true, groupContainer = null, defaultField = '', defaultOperator = 'EQUALS') {
  ...
  valueInput.className = 'input w-[calc(100%-1px)] input-lg relative items-center justify-between cursor-pointer focus:outline-none h-auto p-[9px] text-sm';
...
function addCustomFieldGroup() {
  ...
  valueInput.type = 'text';
  valueInput.placeholder = 'My Website Name';
  valueInput.className = 'input  w-[calc(100%-2px)] input-lg relative items-center justify-between cursor-pointer focus:outline-none h-auto p-[9px] text-sm';
