...
function createConditionRow(hasRemove = true, addButtons = true, groupContainer = null, defaultField = '', defaultOperator = 'EQUALS') {
  ...
  inputRow.className = 'flex items-center gap-2 added-card-when-row justify-start w-full';

  const whenLabel = document.createElement('label');
  whenLabel.className = 'text-sm whitespace-nowrap mt-0 w-[calc(48px-0px)] font-semibold shrink-0';
  ...
  const radioWrapper = document.createElement('div');
  radioWrapper.className = "flex gap-4 items-center flex-1 justify-center hidden";
  radioWrapper.innerHTML = `
  ...
  thenRow.className = 'flex items-center gap-2 added-then-row justify-start';

  const thenLabel = document.createElement('label');
  thenLabel.className = 'text-sm whitespace-nowrap mt-0 w-[calc(48px)] font-semibold shrink-0';
  thenLabel.textContent = 'Then';

  const thenInput = document.createElement('input');
  thenInput.type = 'text';
  thenInput.placeholder = 'Brand';
  thenInput.className = 'input input-lg relative items-center justify-between cursor-pointer focus:outline-none h-auto p-[9px] min-w-[calc(300px-0px)] max-w-[417px] w-[calc(64%-6px)]  text-sm leading-7';
  ...
  if (addButtons) {
    ...
    addConditionBtn.className = 'btn btn-md btn-ghost h-[48px] min-h-[48px] flex-1';
...
function addCustomFieldGroup() {
  ...
  groupContainer.className = 'card bg-base-100 card-border border-base-300 card-sm gap-4 p-4 pt-[24px] custom-field-card';
  ...
  const inputRow = document.createElement('div');
  inputRow.className = 'when-row flex items-center w-full gap-2';

  const whenLabel = document.createElement('label');
  whenLabel.className = ' text-sm whitespace-nowrap mt-0 w-[calc(51px)] font-semibold shrink-0';
  whenLabel.textContent = 'When';
  ...
  fieldSelect.addEventListener('change', () => {
    ...
    if (isBooleanField) {
      ...
      countryWrapper.className = 'flex-1 country-search-wrapper';
  ...
  const thenLabel = document.createElement('label');
  thenLabel.className = ' text-sm whitespace-nowrap mt-0 w-[calc(51px)] font-semibold shrink-0';
  thenLabel.textContent = 'Then';

  const thenInput = document.createElement('input');
  thenInput.type = 'text';
  thenInput.placeholder = 'Brand';
  thenInput.className = 'input input-lg relative items-center justify-between cursor-pointer focus:outline-none h-auto p-[9px] min-w-[calc(398px-0px)] w-[calc(57%-10px)] text-sm leading-7';
  ...
  elseRow.className = 'flex items-center gap-2 else-row';

  const elseLabel = document.createElement('label');
  elseLabel.className = ' text-sm whitespace-nowrap mt-0 w-[calc(51px)] font-semibold shrink-0';
...
function buildCustomFieldSelect({ options, placeholder = 'Select Field' }) {
  ...
  const wrapper = document.createElement('div');
  wrapper.className = 'custom-select-wrapper min-w-[calc(264px-0px)] w-[calc(34%-0px)]';
...
function buildCustomSingleSelect({ options, placeholder, widthClass }) {
  ...
  const wrapper = document.createElement('div');
  wrapper.className = `relative custom-select-wrap  min-w-[calc(160px-0px)] custom-select-wrapper`;
  wrapper.appendChild(select);
